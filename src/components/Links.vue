<template>
  <div class="ph3 ph5-ns pb5">
    <article class="pb3">
      <h2 class="f6 fw7 ttu tracked mv3">Overview of Tachyons</h2>
    ...
    <section class="cf w-100 mt3">
      ...
      <article class="fn fl-ns w-100 w-25-l">
        <h2 class="f6 fw7 ttu tracked mv3" id="layout">Layout</h2>
      ...
      <article class="fn fl-ns w-100 w-25-l">
        <h2 class="f6 fw7 ttu tracked mv3">Theming</h2>
      ...
      <article class="fn fl-ns w-100 w-25-l">
        <h2 class="f6 fw7 ttu tracked mv3">Elements</h2>
