...
&lt;/div&gt;
        ...
        <p class="lh-copy measure">Using the grow class on an element will cause it to scale to 1.05% of its normal size on hover.</p>
        <div class="bl-ns bw2-ns b--black-05 pl3-ns">
...
&lt;/a&gt;
      ...
      <div slot="reference" class="dib v-top">
