<template>
  <div>
    <Page>
      ...
      <article slot="introduction" class="bt b--black-10 pa3 ph5-ns">
...
<section>
<h4 class="f6 fw6">Change text color on hover</h4>
<article class="mt4">
...
<section class="mt5">
<h4 class="f6 fw6">Background color transition on hover</h4>
<article class="mt4">
...
<article class="mt4">
 ...
 &lt;a href="#" class="link b black pv2 db bg-animate hover-bg-washed-red"&gt;bg-animate hover-bg-washed-red&lt;/a&gt;
      ...
      <div slot="reference" class="dib mb4 v-top">
