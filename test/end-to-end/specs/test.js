...
module.exports = {
  ...
  'partials/flexbox': browser => {
    ...
    browser
      ...
      .assert.cssProperty("#l2", "flex", "none")
      ...
      .assert.cssProperty("#l7", "background-repeat", "no-repeat")
      .assert.cssProperty("#l8", "background-position", "50% 100%")
      .assert.cssProperty("#l9", "background-repeat", "no-repeat")
      .assert.cssProperty("#l10", "background-position", "0% 50%")
      .assert.cssProperty("#l11", "background-repeat", "no-repeat")
      .assert.cssProperty("#l12", "background-position", "0% 50%")
      .assert.cssProperty("#l13", "background-repeat", "no-repeat")
      .assert.cssProperty("#l14", "background-position", "0% 50%")
      .assert.cssProperty("#l15", "background-repeat", "no-repeat")
      .assert.cssProperty("#l16", "background-position", "0% 50%")
      .assert.cssProperty("#l17", "background-repeat", "no-repeat")
      .assert.cssProperty("#l18", "background-position", "0% 50%")
      .assert.cssProperty("#l19", "background-repeat", "no-repeat")
      .assert.cssProperty("#l20", "background-position", "0% 50%")
      .assert.cssProperty("#l21", "background-repeat", "no-repeat")
      .assert.cssProperty("#l22", "background-position", "0% 50%")
      .assert.cssProperty("#l23", "background-repeat", "no-repeat")
      .assert.cssProperty("#l24", "background-position", "0% 50%")
      .assert.cssProperty("#l25", "background-repeat", "no-repeat")
      .assert.cssProperty("#l26", "background-position", "0% 50%")
      .assert.cssProperty("#l27", "background-repeat", "no-repeat")
      .assert.cssProperty("#l28", "background-position", "0% 50%")
      .assert.cssProperty("#l29", "background-repeat", "no-repeat")
      .assert.cssProperty("#l30", "background-position", "0% 50%")
      .assert.cssProperty("#l31", "background-repeat", "no-repeat")
      .assert.cssProperty("#l32", "background-position", "0% 50%")
      .assert.cssProperty("#l33", "background-repeat", "no-repeat")
      .assert.cssProperty("#l34", "background-position", "0% 50%")
      .assert.cssProperty("#l35", "background-repeat", "no-repeat")
      .end()
  },
}
